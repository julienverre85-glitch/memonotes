...
logo: { 
 ...
 nav: {
  ...
  modal:        {background:'#fff',border:'1px solid #e5e0d5',borderRadius:'16px 16px 0 0',width:'100%',maxWidth:520,maxHeight:'90vh',overflow:'hidden',display:'flex',flexDirection:'column',boxShadow:'0 20px 60px rgba(0,0,0,0.15)'},
  modalHeader: {
  display: 'flex',
